...
check_path_value gateways.networking.istio.io httpbin-egressgateway '.spec.servers[0].port.number' 80
check_path_value gateways.networking.istio.io httpbin-egressgateway '.spec.servers[0].port.name' http
check_path_value gateways.networking.istio.io httpbin-egressgateway '.spec.servers[0].port.protocol' HTTP
