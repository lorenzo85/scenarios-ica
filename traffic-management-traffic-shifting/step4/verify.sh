...
check_path_value virtualservices.networking.istio.io notification '.spec.http[0].route[0].weight' '80'
...
check_path_value virtualservices.networking.istio.io notification '.spec.http[0].route[1].weight' '20'
