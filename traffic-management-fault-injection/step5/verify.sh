...
check_path_value virtualservices.networking.istio.io notification '.spec.http[0].fault.abort.httpStatus' '500'
check_path_value virtualservices.networking.istio.io notification '.spec.http[0].fault.abort.percentage.value' '100'