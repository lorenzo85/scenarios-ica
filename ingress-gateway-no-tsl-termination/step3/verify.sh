...
check_path_value virtualservices.networking.istio.io booking '.spec.http[0].route[0].destination.port.number' '443'

check_output_contains "curl -s -o /dev/null -w \"%{http_code}\" http://booking.example.com:30000/bookings" 400